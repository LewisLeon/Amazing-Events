const PastContent = document.getElementById("main")
...
Cartas(eventos.EventPast)
filtroMain(eventos.EventPast)
//console.log(eventos.EventPast);
//console.log(eventos.EventUpcoming);
}

/* filtro de cartas en el PastEvents */function filtroMain(events) {
